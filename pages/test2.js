...
console.log(portfolios)
 ...
 {loading ? (
      ...
      <div class=' lg:ml-64 flex space-x-2 justify-center items-center bg-white h-screen dark:invert'>
  ...
  id="portfolioImage"
  name="portfolioImage"
  onChange={(e) => setPortfolioImage(e.target.files[0])} // Capture image file object
  accept="image/*"
...
/>
                ...
                <td className="px-6 py-3 text-sm">
                  <div className="flex items-center cursor-pointer">
                    <div className="ml-4">
                    <input type="text" placeholder='Enter Portfolio Type'   value={portfoliotype}
                                onChange={(e) => setPortfolioType(e.target.value)} className="border border-gray-300 rounded-md px-3 py-1 focus:outline-none focus:ring focus:border-blue-500" />
                    </div>
                  </div>
                </td>
               
                <td className="px-6 py-3 text-sm">
                <input placeholder='Enter Portfolio No. of Share' type="text" value={portfolinoofshare}
                            onChange={(e) => setPortfolioNoofshare(e.target.value)} className="border border-gray-300 rounded-md px-3 py-1 focus:outline-none focus:ring focus:border-blue-500" />
                </td>
                <td className="px-6 py-3 text-sm">
  ...
  // value={pitchdeckpdf} 
  onChange={(e) => setPitchdeckpdf(e.target.files[0])} // Capture file object
  accept=".pdf" 
...
/>
  ...
  // Remove value attribute as it's not applicable for file inputs
  // value={pitchdeckpdf} 
  onChange={(e) => setFinancialpdf(e.target.files[0])} // Capture file object
  accept=".pdf" 
  className="block w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
/>
        ...
        <td class="px-4 py-3">
                              <div class="flex items-center text-sm">
                                <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                  <img class="object-cover w-full h-full rounded-full" src={portfolio.logo || 'default_avatar_url'} alt="" loading="lazy" />
